 ...
 */
public non-sealed class LocalDiskBlobStoreRepository
  implements BlobStoreRepository {
  ...
  public void uploadBlob(String objectName, InputStream inputStream) {
    ...
    try {
      ...
      var folder = parentDirectory == null
  ...
  public void copyBlob(
    ...
    Path sourceFullPath = Paths
      .get(getContainerFolder())
      .resolve(sourceLocalPath);
    Path targetLocalPath = Paths.get(targetObjectName);
    Path targetFullPath = Paths
      .get(prependBasePath(targetFolder))
      .resolve(targetLocalPath);
    try {
      ...
      Path folder = parentDirectory == null
        ...
        : Paths.get(targetFolder).resolve(parentDirectory);
      Files.createDirectories(folder);
