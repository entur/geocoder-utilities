 ...
 */
public non-sealed class InMemoryBlobStoreRepository
  ...
  public void copyBlob(
    ...
    blobsInContainers
      ...
      .put(targetObjectName, sourceData.get(sourceObjectName));
  }
  ...
  private BlobStoreFiles listBlobs(Collection<String> prefixes) {
    ...
    List<BlobStoreFiles.File> files = blobsInContainers
      .keySet()
      .stream()
